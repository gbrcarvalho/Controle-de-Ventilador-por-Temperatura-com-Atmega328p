...
.equ PORT_DISPLAY = PORTD     ; define a porta de saida dos displays
.equ DDR_DISPLAY = DDRD       ; define a porta de saida dos displays
...
volta:
 ...
 Tabela: .dw 0x86BF, 0xCFDB, 0xEDE6, 0x87FD, 0xE7FF, 0xFCF7, 0xDEB9, 0xF1F9
